...
import { createKey } from "../../network/keys";
            ...
            <Group>
                ...
                >
                    ...
                    >
                        ...
                        <TextInput
                            ...
                            description={
                                <>
                                    ...
                                    , нажмите <b>Разрешить</b>, после чего
                                    скопируйте содержимое адресной строки между{" "}
                                    <b>access_token=</b> и <b>&expires_in</b>.
                                    Не обращайте внимание на содержимое страницы
                                </>
                            }
                            mb={"md"}
                            placeholder={"vk1.a..."}
                        ...
                        >
                            <Text size={"xs"} mb={"xs"}>
                                В случае, если доступ к базе данных получит
                                злоумышленник, у вас будет время на
                                аннулирование ключей доступа{" "}
                                <a
                                ...
                                привязанных страниц. Чем длиннее и сложнее
                                пароль, тем потенциально больше времени у вас
                                будет до момента, когда вашим ключом
                                воспользуются.
                            </Text>
                            <Text size={"xs"} mb={"xs"}>
                                Ввод пароля также понадобится для совершения
                                действий, связанных с ВКонтакте, например, при
                                постинге новостей.
                            </Text>
                            <Text size={"xs"}>
                                После добавления ключа он будет скрыт и вы
                                больше никогда его не увидите. Если он нужен вам
                                в исходном виде, то запишите его, однако
                                делиться им нельзя ни в коем случае.
                            </Text>
                        </Alert>
